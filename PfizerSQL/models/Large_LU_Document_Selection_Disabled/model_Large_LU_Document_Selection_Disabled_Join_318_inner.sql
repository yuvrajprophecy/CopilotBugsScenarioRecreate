...
WITH LARGE_AKA_GPDIP_EDLUD_324 AS (

  SELECT * 
  
  FROM {{ source('prophecy__temp_Large_LU_Document_Selection_Disabled_source', 'prophecy__temp_Large_LU_Document_Selection_Disabled_pre_Filter_323_reject_0') }}
...
Filter_323_reject AS (
  ...
  FROM LARGE_AKA_GPDIP_EDLUD_324 AS in0
