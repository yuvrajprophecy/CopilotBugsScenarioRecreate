...
WITH LARGE_AKA_GPDIP_EDLUD_312 AS (

  SELECT * 
  
  FROM {{ source('prophecy__temp_Large_LU_Document_Selection_Disabled_source', 'prophecy__temp_Large_LU_Document_Selection_Disabled_pre_Join_313_inner_1') }}
...
Join_318_inner AS (
  ...
  FROM {{ source('prophecy__temp_Large_LU_Document_Selection_Disabled_source', 'prophecy__temp_Large_LU_Document_Selection_Disabled_pre_Join_313_inner_0') }}
...
Join_313_inner AS (
  ...
  INNER JOIN LARGE_AKA_GPDIP_EDLUD_312 AS in1
...
LARGE_AKA_GPDIP_EDLUD_298_1 AS (

  SELECT * 
  
  FROM {{ source('prophecy__temp_Large_LU_Document_Selection_Disabled_source', 'prophecy__temp_Large_LU_Document_Selection_Disabled_pre_Join_299_inner_1') }}
...
Join_310_inner AS (
  ...
  FROM {{ source('prophecy__temp_Large_LU_Document_Selection_Disabled_source', 'prophecy__temp_Large_LU_Document_Selection_Disabled_pre_Join_299_inner_0') }}
...
Join_299_inner AS (
  ...
  INNER JOIN LARGE_AKA_GPDIP_EDLUD_298_1 AS in1
     ON in0.r_object_id = in1.r_object_id
